...
- How text is transformed into numerical vectors
- The importance of term weighting (TF-IDF)
- The difference between Term Frequency (TF) and Document Frequency (DF)
- Sparse vector representation and its efficiency
